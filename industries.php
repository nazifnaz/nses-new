    ...
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="breadcrumb-custom"><a href=" {% url 'page_view' '">Home</a> <span
                        class="mx-2">&gt;</span> <span>Industries</span></p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a href="#" class="unit-1 text-center">
                    ...
                    <div class="unit-1-text">
                        ...
                        <p class="px-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos tempore ullam minus
                            voluptate libero.</p>
                    </div>
                </a>
            </div>
